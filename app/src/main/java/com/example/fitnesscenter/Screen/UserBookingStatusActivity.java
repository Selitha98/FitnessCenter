...
public class UserBookingStatusActivity extends AppCompatActivity {
        ...
        dRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    if(postSnapshot.child("Name").getValue(String.class).equals(getUsername(UserBookingStatusActivity.this))){
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(UserBookingStatusActivity.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    }
    public class ArrayAdapter extends RecyclerView.Adapter<ArrayAdapter.ImageViewHoler> {
        ...
        public ArrayAdapter.ImageViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v= LayoutInflater.from(UserBookingStatusActivity.this).inflate(R.layout.item_users1,parent,false);
